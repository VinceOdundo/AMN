  ...
  return (
    <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="profession" className="block mb-1 font-medium">Profession</label>
          <select
            id="profession"
            name="profession"
        ...
        <button type="submit" className="w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 transition duration-300">Create Account</button>
      </form>
